class MarkerManager {
  ...
  updateMarkers(spots) {
    ...
    spots
      ...
      .forEach(filteredSpot =>
        this.createMarker(filteredSpot, this.handleClick)
      );
    Object.keys(this.markers)
      .filter(spotId => !spotsList[spotId])
  ...
  createMarker(spot) {
    ...
    const icon = {
      url:
        "https://djqvcbmmgpti5.cloudfront.net/assets/map/hipcamp-pin-acd5fbe15a2cc72f5919e5e86a32872fb43c7dbf03ebee8f3f1868c80123f002.png",
