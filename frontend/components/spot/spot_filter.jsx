...
class SpotFilter extends Component {
  ...
  toggle(category) {
    const { filters, removeSingleFilter, receiveSingleFilter } = this.props;
  ...
  handleGroupFilter(amount) {
    const { receiveGroupFilter, removeGroupFilter, filters } = this.props;
      ...
      <div className="spot_filters_header">
        <div className="spot_filters_container">
          <div className="spot_filter_section">
            <button onClick={this.showAmenities}>Amenities</button>
            {this.state.showAmenities ? (
              ...
              >
                ...
                <button
                  className={
                    this.state.pets_allow ? "active_filter_button" : ""
                  }
                  name="pets_allow"
          ...
          <div className="spot_filter_section">
            <button onClick={this.showActivities}>Activities</button>
          ...
          <div className="spot_filter_section">
            <button onClick={this.showGroup}>Group Size</button>
            {this.state.showGroup ? (
              ...
              >
                <button
                  ...
                  name="group5"
                  onClick={this.handleGroupFilter(5)}
                >
                  5+ Campers
                </button>
                <button
                  ...
                  name="group10"
                  onClick={this.handleGroupFilter(10)}
                >
                  10+ Campers
                </button>
                <button
                  ...
                  name="group20"
                  onClick={this.handleGroupFilter(20)}
                >
                  20+ Campers
                </button>
              </div>
          ...
          <div className="spot_filter_section">
            <button onClick={this.showPricing}>Pricing</button>
