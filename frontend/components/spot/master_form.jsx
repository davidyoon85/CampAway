...
class MasterForm extends Component {
  ...
  handleFile(event) {
    ...
    reader.onloadend = () =>
      this.setState({
        photoUrl: this.state.photoUrl.concat([reader.result]),
        photoFile: this.state.photoFile.concat([file])
      });
    if (file) {
  ...
  handleChange(event) {
    ...
    if (name === "address") {
      ...
      geocodeByAddress(value)
        ...
        .then(({ lat, lng }) => this.setState({ lat: lat, long: lng }));
    } else {
      this.setState({
        [name]: value
      });
  ...
  handleSubmit(event) {
    ...
    formData.append("spot[body]", body);
    formData.append("spot[price]", price);
    formData.append("spot[pets_allow]", pets_allow);
    formData.append("spot[group_size]", group_size);
    formData.append("spot[check_in]", check_in);
    formData.append("spot[check_out]", check_out);
    formData.append("spot[lat]", lat);
    formData.append("spot[long]", long);
    formData.append("spot[campfire]", campfire);
    formData.append("spot[tent]", tent);
    formData.append("spot[sites]", sites);
    formData.append("spot[parking]", parking);
    formData.append("spot[toilet]", toilet);
    formData.append("spot[shower]", shower);
    formData.append("spot[hiking]", hiking);
    formData.append("spot[biking]", biking);
    formData.append("spot[wildlife]", wildlife);
    formData.append("spot[paddling]", paddling);

    this.props.hostSpot(formData).then(response => {
      return this.props.history.push(`/spots/${Object.keys(response.spot)[0]}`);
    });
  }
  ...
  previousButton() {
    ...
    if (currentStep !== 1) {
      ...
      return (
        <button className="null_arrow" type="button">
          <i className="fas fa-angle-left" />
        </button>
      );
    }
    ...
    if (this.state.currentStep === 1) {
      ...
      step = (
        <>
          ...
          <div className="form-group">
            <label className="form_group_title" htmlFor="check_in">
              Check In Time
            </label>
            <input
              className="form-control"
          ...
          <div className="form-group">
            <label className="form_group_title" htmlFor="check_out">
              Check Out Time
            </label>
            <input
              className="form-control"
      ...
      step = (
        <React.Fragment>
          <>
            <div className="host_options_title">Choose Camp Features!</div>
              ...
              <div className="host_option_main">
                ...
                <div className="form-group-options">
                  <input
                    ...
                    className={
                      this.state.tent ? "active_button" : "host_spot_options"
                    }
                    name="tent"
                    onClick={this.handleClick}
                  />
                ...
                <div className="form-group-options">
                  <input
                    ...
                    className={
                      this.state.parking ? "active_button" : "host_spot_options"
                    }
                    name="parking"
                    onClick={this.handleClick}
                  />
                ...
                <div className="form-group-options">
                  <input
                    ...
                    className={
                      this.state.toilet ? "active_button" : "host_spot_options"
                    }
                    name="toilet"
                    onClick={this.handleClick}
                  />
                ...
                <div className="form-group-options">
                  <input
                    ...
                    className={
                      this.state.shower ? "active_button" : "host_spot_options"
                    }
                    name="shower"
                    onClick={this.handleClick}
                  />
                ...
                <div className="form-group-options">
                  <input
                    ...
                    className={
                      this.state.hiking ? "active_button" : "host_spot_options"
                    }
                    name="hiking"
                    onClick={this.handleClick}
                  />
                ...
                <div className="form-group-options">
                  <input
                    ...
                    className={
                      this.state.biking ? "active_button" : "host_spot_options"
                    }
                    name="biking"
                    onClick={this.handleClick}
                  />
          ...
          <input
            ...
            multiple
          />
          <label className="photo_upload_button" htmlFor="photo_upload">
        ...
        <div className="form_container">
          ...
          <div className="spot_form_message">
            <div className="host_message_header">
              <img
                className="host_photo"
                src="https://camp-away-dev.s3.amazonaws.com/profile.jpg"
                alt=""
              />
            ...
            <div className="host_message">
              <p>
                “My team and I are so excited you've chosen us to be your
                partner in sharing your land with our community of CampAwayers
                across the country.
              </p>
              <p>We want to help you achieve your hosting goals.</p>
              <p>
                <a href="mailto:dev.davidyoon@gmail.com">
                  <nobr className="host_message_email">
