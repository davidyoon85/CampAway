    ...
    return (
      <>
        <main className="splash_main">
          <div className="splash_subtitle1">Find yourself outside.</div>

          <div className="splash_subtitle2">
            Book unique camping experiences on over{" "}
            <nobr className="bold">300,000</nobr> campsites, ranches, vineyards,
            public parks and more.
          </div>

          <div className="search_bar_main">
            <i className="fas fa-search search_bar_icon" />
          ...
          <div className="splash_subtitle3">Discover camping...</div>

          <div className="splash_container">
            <div className="splash_main_section">
              <div
                className="splash_section"
                onClick={() => this.handleClick(0)}
              >
                <div className="splash_section_img">
                  <img
                    src="https://s3.amazonaws.com/camp-away-dev/spot1_0.jpg"
                    alt=""
                  />
                </div>
              ...
              >
                <div className="splash_section_img">
                  <img
                    src="https://s3.amazonaws.com/camp-away-dev/spot2_0.jpg"
                    alt=""
                  />
                </div>
                <div className="splash_section_details">
              ...
              >
                <div className="splash_section_img">
                  <img
                    src="https://s3.amazonaws.com/camp-away-dev/spot3_0.jpg"
                    alt=""
                  />
                </div>
                <div className="splash_section_details">
              ...
              >
                <div className="splash_section_img">
                  <img
                    src="https://s3.amazonaws.com/camp-away-dev/spot4_0.jpg"
                    alt=""
                  />
                </div>
                <div className="splash_section_details">
              ...
              >
                <div className="splash_section_img">
                  <img
                    src="https://s3.amazonaws.com/camp-away-dev/spot5_0.jpg"
                    alt=""
                  />
                </div>
                <div className="splash_section_details">
              ...
              >
                <div className="splash_section_img">
                  <img
                    src="https://camp-away-dev.s3.amazonaws.com/spot9_0.jpg"
                    alt=""
                  />
                </div>
                <div className="splash_section_details">
                  <h3 className="splash_section_name">
                    Rustic, Enchanted Cabin
                  </h3>
                  <div className="splash_section_location">New York</div>
                </div>
              </div>
            ...
            <div className="foot_div_section">
              ...
              <div className="foot_social">
                <div className="foot_social_title">
                  <div className="foot_description_title">Social</div>

                  <div className="social_link_li">
                    <a
                      href="https://github.com/davidyoon85"
                  ...
                  <div className="social_link_li">
                    <a
                      href="https://www.linkedin.com/in/davidyoon85"
                      className="social_link"
                    >
                  ...
                  <div className="social_link_li">
                    <a
                      href="https://davidyoon85.github.io"
                      className="social_link"
                    >
                      <i id="portfolio_link" className="fas fa-user">
                        {" "}
                        &nbsp; Portfolio
                      </i>
                    </a>
